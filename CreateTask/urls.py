...
urlpatterns = [
    ...
    url(r'^TextAnnoExampleAdd/(?P<task_id>[0-9]+)/$',views.AddTextAnnoExamples, name='TextAnno_example_add'),
    url(r'^MediaAnnoExampleAdd/(?P<task_id>[0-9]+)/$',views.AddMediaAnnoExamples, name='MediaAnno_example_add'),
    url(r'^MediaAnnoExampledo/(?P<task_id>[0-9]+)/$',views.doMediaAnnoExamples, name='MediaAnno_example_do'),
