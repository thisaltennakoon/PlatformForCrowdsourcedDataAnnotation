                ...
                with transaction.atomic():
                    ...
                    if len(data_annotation) > 0:
                        ...
                        if len(annotated_data_instances) > 0:
                            return render(request, 'DoTask/DataAnnotationTask.html', {'data_instance_available': True,
                        ...
                        if len(annotated_data_instances) > 0:
                            return render(request, 'DoTask/DataAnnotationTask.html', {'data_instance_available': False,
                                                                                                    'task_object': Task.objects.get(id=task_id),
                                                                                                    'task_id': task_id,
                                                                                                    'annotated_data_instances_available': True,
                                                                                                    'annotated_data_instances': annotated_data_instances})
